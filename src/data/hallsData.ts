...
export const HALLS_DATA: Hall[] = [
  {
    ...
    badgeText: 'ALPHA HALL • RM200 Half Day / RM400 Full Day',
    features: [
      '13 Tables & 53 Chairs',
  ...
  },
  {
    ...
    description: 'Flexible two-side event space for up to 31 guests per side or 80 chairs when booked as the full hall.',
    maxCapacity: 80,
    sideCapacity: 31,
    minCapacity: 1,
    pricePerHour: 40,
    ...
    halfDayRate: 400,
    fullDayRate: 800,
    halfHallHalfDayRate: 200,
    halfHallFullDayRate: 400,
    sizeSqFt: 750,
    primaryImage: hallBPanoramicImg,
    secondaryImages: [hallB1Img, hallB2Img, surauFacilityImg],
    secondaryImageLabels: ['Hall B - Side A', 'Hall B - Side B', 'Surau Facility'],
    badgeText: 'HALL B • Up to 80 Chairs • From RM200',
    features: [
      'Up to 31 Guests Per Side / 80 Chairs Full Hall',
