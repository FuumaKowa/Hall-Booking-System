        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-stone-100">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <button
              ...
              className="bg-emerald-700 hover:bg-emerald-800 text-white font-bold px-5 py-2.5 rounded-xl text-xs sm:text-sm transition-colors duration-150 shadow-xs flex items-center space-x-2 cursor-pointer"
            >
